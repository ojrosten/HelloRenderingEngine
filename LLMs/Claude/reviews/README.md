...
| `sequoia_advice_review_2026-07-21.md` | 2026-07-21 | Advice framework (`tutor`/`advisor_analyser`/`advice_data` + plumbing through checkers, string tester, allocation advice): dead metafunctions, constraint-boundary gaps, narrowing-guard hole, test/doc drift | **AD** (advice) |
