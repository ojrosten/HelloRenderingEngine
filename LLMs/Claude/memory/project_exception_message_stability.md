...
metadata: 
  ...
  modified: 2026-07-21T10:57:06.109Z
---
...
3. **Genuinely platform-dependent text** (driver-authored error strings) is not scrubbed but forked: curlew's `output_discriminator()` suffixes the exceptions file per OS/renderer/GL-version — see [[avocet-discriminator-axes]] for the machinery and its sibling `summary_discriminator`.
