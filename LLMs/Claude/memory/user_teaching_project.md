...
**Lecture format & cadence:** 49 lectures delivered as of 2026-07 (lecture 50 in prep), each ~1 hour: ~40 min presentation + ~20 min live coding. Some infrastructure is prepared off-line, but the amount of code added per lecture is necessarily small. This means:
