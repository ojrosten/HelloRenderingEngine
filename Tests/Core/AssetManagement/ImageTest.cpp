...
namespace avocet::testing
{
    ...
    void image_test::test_image(Transform transform) {

        check_semantics(
            "",
            transform(image{working_materials() / "red_2w_3h_3c.png",         flip_vertically::no,  all_channels_in_image}),
            transform(image{working_materials() / "bgr_striped_2w_3h_3c.png", flip_vertically::yes, all_channels_in_image}),
        ...
        check_semantics(
            ...
            transform(image{working_materials() / "red_2w_3h_3c.png",         flip_vertically::no,  image_channels{1}}),
            transform(image{working_materials() / "bgr_striped_2w_3h_3c.png", flip_vertically::yes, image_channels{4}}),
        ...
        check_semantics(
            ...
            transform(to_image(make_red(        2, 3, image_channels{3}, alignment{1}, 255))),
            transform(to_image(make_rgb_striped(2, 3, image_channels{4}, alignment{4}))),
            make_red(        2, 3, image_channels{3}, alignment{1}, 255),
        ...
        check_semantics(
            ...
            transform(to_image(make_red(2, 3, image_channels{3}, alignment{4}, 255))),
            transform(to_image(make_red(2, 3, image_channels{1}, alignment{2}, 0))),
