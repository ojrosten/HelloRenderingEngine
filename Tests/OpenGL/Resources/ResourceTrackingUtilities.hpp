...
namespace avocet::testing
{
    ...
    protected:
        ...
        void execute_tests(std::string_view expectedGPUCall, opengl::int_names glGetName, Creator creator, Utilizer utilizer) {
            check_serial_tracking_non_overlapping_lifetimes(expectedGPUCall, glGetName, creator, utilizer);
            check_serial_tracking_overlapping_lifetimes(expectedGPUCall, glGetName,creator, utilizer);

            check_threaded_tracking_non_overlapping_lifetimes(expectedGPUCall, glGetName, creator, utilizer);
            check_threaded_tracking_overlapping_lifetimes(expectedGPUCall, glGetName,  creator, utilizer);
        }
    ...
    private:
        ...
        void check_serial_tracking_non_overlapping_lifetimes(std::string_view expectedGPUCall, opengl::int_names glGetName, creator_type creator, utilizer_type utilizer);

        void check_serial_tracking_overlapping_lifetimes(std::string_view expectedGPUCall, opengl::int_names glGetName, creator_type creator, utilizer_type utilizer);

        void check_threaded_tracking_non_overlapping_lifetimes(std::string_view expectedGPUCall, opengl::int_names glGetName, creator_type creator, utilizer_type utilizer);

        void check_threaded_tracking_overlapping_lifetimes(std::string_view expectedGPUCall, opengl::int_names glGetName, creator_type creator, utilizer_type utilizer);
    };
}
