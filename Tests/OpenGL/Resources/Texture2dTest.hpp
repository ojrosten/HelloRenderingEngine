...
namespace avocet::testing
{
    ...
    private:
        ...
        void do_check_semantics_via_texture_data(const reporter& description, const curlew::window& w, opengl::texture_2d&& tex2d, const texture_data& first, const texture_data& second) {
            check_semantics(
                description,
                std::move(tex2d),
        ...
        void do_check_semantics_via_texture_data(const reporter& description, const curlew::window& w, opengl::texture_2d&& tex2d, const image_data& extracted1, const texture_data& sent2, const image_data& extracted2) {
            check_semantics(
                description,
                std::move(tex2d),
