                ...
                .common_config{
                    ...
                    .parameter_setter{
                        [&ctx]() {
                            ...
                            gl_function{&GladGLContext::TexParameteri}(ctx, GL_TEXTURE_2D, GL_TEXTURE_BASE_LEVEL, 0);
                            gl_function{&GladGLContext::TexParameteri}(ctx, GL_TEXTURE_2D, GL_TEXTURE_MAX_LEVEL , 0);
                        }
                    },
                    .label{}
                 },
