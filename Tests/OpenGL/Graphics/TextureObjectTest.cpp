    ...
    void texture_2d_object_test::run_tests()
    {
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals,  1, 1, image_channels{4}, alignment{4}}, .colour_space{}, .parameter_setter{}, .label{}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{3}, alignment{1}}, .colour_space{}, .parameter_setter{}, .label{}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals,  1, 1, image_channels{4}, alignment{4}}, .colour_space{}, .parameter_setter{}, .label{}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 1, 2, image_channels{3}, alignment{4}}, .colour_space{}, .parameter_setter{}, .label{}}},
                opt_data{{textureVals,  1, 1, agl::texture_format::rgba, alignment{4}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals,  3, 1, image_channels{1}, alignment{2}}, .colour_space{}, .parameter_setter{}, .label{}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 1, 3, image_channels{2}, alignment{2}}, .colour_space{}, .parameter_setter{}, .label{}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals,  1, 1, image_channels{1}, alignment{1}}, .colour_space{}, .parameter_setter{}, .label{}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{3}, alignment{1}}, .colour_space{}, .parameter_setter{}, .label{}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals,  1, 1, image_channels{2}, alignment{1}}, .colour_space{}, .parameter_setter{}, .label{}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{4}, alignment{1}}, .colour_space{}, .parameter_setter{}, .label{}}},
