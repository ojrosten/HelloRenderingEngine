    ...
    void texture_2d_object_test::run_tests()
    {
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals, 1, 1, image_channels{4}, 1}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{3}, 1}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals, 1, 1, image_channels{1}, 1}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{3}, 1}}},
...

        {
            ...
            check_semantics(
                ...
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals, 1, 1, image_channels{2}, 1}}},
                agl::texture_2d{agl::texture_2d_configuration{.data{textureVals2, 2, 1, image_channels{4}, 1}}},
