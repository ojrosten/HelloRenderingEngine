...
namespace avocet::testing
{
    ...
    void texture_2d_test::run_tests()
    {
        ...
        check_semantics_via_texture_data(
            ...
            {.image{.data{42, 6,       9, 1},       .width{1}, .height{2}, .num_channels{2}, .row_alignment{2}}, .decoding{}, .label{}},
                   {.data{42, 6, 0, 0, 9, 1, 0, 0}, .width{1}, .height{2}, .num_channels{2}, .row_alignment{4}}
        );
