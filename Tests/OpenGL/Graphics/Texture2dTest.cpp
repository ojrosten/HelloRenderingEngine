...
namespace avocet::testing
{
    ...
    void texture_2d_test::run_tests()
    {
        ...
        check_semantics_via_texture_data(
            ...
            {.image{.data{ 42, 7,  6, 10},         .width{1}, .height{1}, .num_channels{4}, .row_alignment{4}}, .colour_space{}, .label{}},
            {.image{.data{255, 7, 42,  1, 255, 3}, .width{2}, .height{1}, .num_channels{3}, .row_alignment{1}}, .colour_space{}, .label{}}
        );

        check_semantics_via_texture_data(
            "Faithfully aligned roundtrip rgba and rgb: rgb data is sent and received padded",
            {.image{.data{42,  7,  6, 0},               .width{1}, .height{1}, .num_channels{4}, .row_alignment{4}}, .colour_space{}, .label{}},
            {.image{.data{255, 7, 42, 0, 1, 255, 3, 0}, .width{1}, .height{2}, .num_channels{3}, .row_alignment{4}}, .colour_space{}, .label{}}
        );

        check_semantics_via_texture_data(
            "Faithful roundtrip red and rg: data sent and received naturally aligned",
            {.image{.data{42,  7,  6},            .width{3}, .height{1}, .num_channels{1}, .row_alignment{1}}, .colour_space{}, .label{}},
            {.image{.data{255, 7, 42, 1, 255, 3}, .width{1}, .height{3}, .num_channels{2}, .row_alignment{2}}, .colour_space{}, .label{}}
        );

        check_semantics_via_texture_data(
            "Faithfully aligned roundtrip red and rg: red data is sent and received padded",
            {.image{.data{42,  7,  6, 0},         .width{3}, .height{1}, .num_channels{1}, .row_alignment{2}}, .colour_space{}, .label{}},
            {.image{.data{255, 7, 42, 1, 255, 3}, .width{1}, .height{3}, .num_channels{2}, .row_alignment{2}}, .colour_space{}, .label{}}
        );
        ...
        check_semantics_via_texture_data(
            ...
            {.image{.data{255, 7,       1, 255},       .width{1}, .height{2}, .num_channels{2}, .row_alignment{1}}, .colour_space{}, .label{}},
        ...
        check_semantics_via_texture_data(
            ...
            {.image{.data{42},                              .width{1}, .height{1}, .num_channels{1}, .row_alignment{1}}, .colour_space{}, .label{}},
