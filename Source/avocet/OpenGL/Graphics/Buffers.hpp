...
namespace avocet::opengl {
    ...
    template<class... Attributes>
        requires   (is_legal_gl_buffer_value_type_v<Attributes> && ...)
                && sequoia::are_same_v<gl_arithmetic_type_of_t<Attributes>...>
                && (sizeof(sequoia::mem_ordered_tuple<Attributes...>) == (sizeof(Attributes) + ...))
    struct is_legal_gl_buffer_value_type<sequoia::mem_ordered_tuple<Attributes...>> : std::true_type
    {};
