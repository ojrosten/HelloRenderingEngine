...
namespace avocet::opengl {
    ...
    private:
        ...
        static void do_draw(const GladGLContext& ctx) {
            gl_function{ctx, ctx.DrawElements}(GL_TRIANGLES, num_elements, to_gl_enum(to_gl_type_specifier_v<element_index_type>), nullptr);
        }
    ...
    private:
        ...
        static void do_draw(const GladGLContext& ctx) {
            gl_function{ctx, ctx.DrawArrays}(GL_TRIANGLES, 0, 3);
        }
    };
