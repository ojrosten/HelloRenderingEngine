...
namespace avocet::opengl {
    ...
    public:
        ...
        polygon_base(const activating_context& ctx, Fn transformer, const std::optional<std::string>& label)
        ...
        polygon_base(const activating_context& ctx, Fn transformer, const texture_2d_configurator& texConfig, const std::optional<std::string>& label)
            :      m_VBO{ctx, transformer(st_Vertices), label}
            ,      m_VAO{ctx, label, m_VBO}
        ...
        polygon_base(const activating_context& ctx, Fn transformer, std::span<const texture_2d_configurator, num_textures> texConfigs, const std::optional<std::string>& label)
            : m_VBO{ctx, transformer(st_Vertices), label}
            , m_VAO{ctx, label, m_VBO}
    ...
    public:
        ...
        template<class Fn>
            requires std::is_invocable_r_v<vertices_type, Fn, vertices_type> && (num_textures == 0)
        polygon(const activating_context& ctx, Fn transformer, const std::optional<std::string>& label)
        ...
        template<class Fn>
            requires std::is_invocable_r_v<vertices_type, Fn, vertices_type> && (num_textures == 1)
        polygon(const activating_context& ctx, Fn transformer, const texture_2d_configurator& texConfig, const std::optional<std::string>& label)
        ...
        template<class Fn>
            requires std::is_invocable_r_v<vertices_type, Fn, vertices_type>
        polygon(const activating_context& ctx, Fn transformer, std::span<const texture_2d_configurator, num_textures> texConfigs, const std::optional<std::string>& label)
