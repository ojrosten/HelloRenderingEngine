...
namespace avocet::opengl {
    ...
    public:
        ...
        explicit(sizeof...(Args) == 0) generic_shader_resource(const extended_context& ctx, const Args&... args)
    ...
    struct shader_program_resource_lifecycle {
        [[nodiscard]]
        static contextual_resource_handle create(const extended_context& ctx) {
    ...
    public:
        shader_program(const extended_context& ctx, const std::filesystem::path& vertexShaderSource, const std::filesystem::path& fragmentShaderSource);
