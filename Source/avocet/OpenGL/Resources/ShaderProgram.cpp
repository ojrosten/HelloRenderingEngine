...
namespace avocet::opengl {
    ...
    namespace {
        ...
        public:
            ...
            [[nodiscard]]
            contextual_resource_handle create(const extended_context& ctx) {
        ...
        public:
            shader_compiler(const extended_context& ctx, shader_species species, const fs::path& sourceFile)
    ...
    shader_program::shader_program(const extended_context& ctx, const std::filesystem::path& vertexShaderSource, const std::filesystem::path& fragmentShaderSource)
        : m_Resource{ctx}
    {
        shader_compiler
