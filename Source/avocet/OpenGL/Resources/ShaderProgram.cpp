...
namespace avocet::opengl {
    ...
    namespace {
        ...
        public:
            ...
            [[nodiscard]]
            contextual_resource_handle create(const decorated_context_base& ctx) {
        ...
        public:
            shader_compiler(const decorated_context_base& ctx, shader_species species, const fs::path& sourceFile)
    ...
    shader_program::shader_program(const decorated_context_base& ctx, const std::filesystem::path& vertexShaderSource, const std::filesystem::path& fragmentShaderSource)
        : m_Resource{ctx}
    {
        shader_compiler
