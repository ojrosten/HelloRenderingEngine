...
namespace avocet::opengl {
    namespace {
        ...
        void load_to_gpu(const extended_context& ctx, const texture_2d_configurator& config) {
        ...
        [[nodiscard]]
        GLint extract_texture_2d_param(const extended_context& ctx, GLenum paramName) {
            GLint param{};
