...
namespace avocet::opengl {
    ...
    struct vao_lifecycle_events {
        ...
        static void bind(const contextual_resource_ref& h) { gl_function{&GladGLContext::BindVertexArray}(h.context(), get_index(h)); }

        static void configure(const contextual_resource_ref& h, const configurator& config) {
    ...
    struct buffer_lifecycle_events : common_buffer_lifecycle_events {
        ...
        static void bind(const contextual_resource_ref& h) { gl_function{&GladGLContext::BindBuffer}(h.context(), to_gl_enum(Species), get_index(h)); }
