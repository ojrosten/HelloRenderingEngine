...
namespace avocet::opengl {
    ...
    inline void add_label(object_identifier identifier, const contextual_resource_ref& h, const optional_label& label) {
    ...
    [[nodiscard]]
    inline std::string get_object_label(avocet::opengl::object_identifier identifier, const avocet::opengl::contextual_resource_ref& handle) {
