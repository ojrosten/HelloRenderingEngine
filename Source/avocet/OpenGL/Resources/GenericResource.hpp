...
namespace avocet::opengl {
    ...
    inline constexpr bool has_resource_lifecycle_events_v{
        requires(raw_indices<NumResources.value>& indices, const contextual_resource_ref& h) {
    ...
    struct resource_lifecycle {
        ...
        static void bind(const contextual_resource_ref& h) { LifeEvents::bind(h); }

        static void configure(const contextual_resource_ref& h, const configurator_type& config) {
