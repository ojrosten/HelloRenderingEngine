...
namespace avocet::opengl {
    ...
    class resource_lifecycle<NumResources, LifeEvents>
        : public resource_lifecycle_base<NumResources, LifeEvents>
    {
    public:
        constexpr static std::size_t N{NumResources.value};
    ...
    class resource_lifecycle<num_resources{1}, LifeEvents>
        : public resource_lifecycle_base<num_resources{1}, LifeEvents>
    {
    public:
